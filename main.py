...
while True:
    main_input = input(
        "Оскільки даний код - Бібліотека, то прошу обрати команду для виконання: "
    ...
    if main_input == "1":
        ...
        while True:
            ...
            if pages_read <= pages_qty:
                ...
                print(
                    "Неможливо прочитати більше сторінок, ніж є в книзі. Повернення до вводу сторінок"
                )
    elif main_input == "2":
        ...
        print(
            "Ви ввели неправильне значення, повернення до початкового запиту (дані збережені)"
        )
